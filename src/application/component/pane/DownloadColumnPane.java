...
public class DownloadColumnPane extends AnchorPane {
	private String m3u8;
	private String dir;
	...
	private ConcurrentLinkedQueue<EXTINF> remain = new ConcurrentLinkedQueue<>();

	public DownloadColumnPane(String m3u8, String dir) {
		this.m3u8 = m3u8;
		this.dir = dir;
