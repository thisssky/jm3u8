...
//"https://youku.cdn7-okzy.com/20191126/15946_b6e68816/index.m3u8";
//"https://youku.cdn7-okzy.com/20191126/15946_b6e68816/1000k/hls/index.m3u8";
...
public class M3U8 {
	...
	public static void main(String[] args) {
		...
		getList("https://www2.800-cdn.com/ppvod/pyEB825o.m3u8");
	}

	public static List<String> getList(String url) {
		url = firstIndex(url);
		String indexFile = secondIndex(url);
		// 解析索引文件
		List<String> videoUrlList = getTS(indexFile);
		return videoUrlList;
	}

	public static String firstIndex(String urlPath) {
	...
	public static String secondIndex(String urlPath) {
...
//		url = "https://youku.cdn7-okzy.com/20191126/15946_b6e68816/1000k/hls/index.m3u8";
	...
	public static List<String> getTS(String content) {
