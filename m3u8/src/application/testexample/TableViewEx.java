...
public class TableViewEx extends Application {
	...
	public void tableView() {
		...
		indexColumn = new TableColumn<TableViewEx.Student, String>("序号");
		...
		firstNameColumn = new TableColumn<TableViewEx.Student, String>("姓氏");
		firstNameColumn.setCellValueFactory(new PropertyValueFactory<Student, String>("firstName"));

		lastNameColumn = new TableColumn<TableViewEx.Student, String>("名字");
		lastNameColumn.setCellValueFactory(new PropertyValueFactory<Student, String>("lastName"));

		ageColumn = new TableColumn<TableViewEx.Student, Integer>("年龄");
		...
		adultColumn = new TableColumn<TableViewEx.Student, Boolean>("成年");
		...
		deleteColumn = new TableColumn<TableViewEx.Student, String>("删除");
